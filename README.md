...
- 💻 Passionate Full-Stack Web Developer, focusing on React, Node.js, and MongoDB.
- 🛡️ Actively involved in Cybersecurity and regular Capture The Flag (CTF) participant.
- 🔗 Connect: [LinkedIn](https://www.linkedin.com/in/fabliha-deya/) | [Portfolio](https://github.com/Deya824)

## 💎 My Absolute Favorites
- 🏗️ Crafting clean, interactive frontend and robust backend applications.
- 🤖 Algorithm design and Competitive Programming (using C++).
- ⛓️ Creating educational blockchain simulation visualizers.
