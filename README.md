...
I am a Computer Science student dedicated to building secure, interactive, and efficient digital solutions.

## 🌐 Connect with me:
- 💼 **LinkedIn:** [Fabliha Deya](https://www.linkedin.com/in/fabliha-deya/)
- 🐙 **GitHub:** [Deya824](https://github.com/Deya824)

## 🌟 Talking about Personal Stuff!
- 🎓 I'm currently a CSE undergrad at RUET (Rajshahi University of Engineering & Technology).
- 🛡️ The banner's shield perfectly mirrors my deep-seated interest in Cybersecurity. I explore secure coding practices and regularly participate in CTF (Capture The Flag) challenges.
- 💻 I am a passionate Full-Stack Web Developer, focusing heavily on React, Node.js, and MongoDB.
- 🤖 Algorithm design and Competitive Programming (using C++) are where I hone my problem-solving skills.
- ⛓️ I am also currently developing interactive educational tools, including a Blockchain simulation visualizer.

## 💎 My Absolute Favorites
- 🏗️ Crafting clean, interactive frontend experiences and robust backend architectures.
- 🔐 Diving deep into web exploitation vulnerabilities to understand how to build safer web apps.
...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/node.js-%2343853D.svg?style=for-the-badge&logo=node.js&logoColor=white" alt="Node.js" style="margin: 5px;" />
